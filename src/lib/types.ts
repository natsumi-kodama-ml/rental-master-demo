...
// 予約受付を行うのはゲームの新品予約のみ。中古・レンタル落ちの予約や、
// DVD・CD・コミックの発売前/レンタル開始前の予約は正式には受け付けない。
export function canReserve(category: Category, dealType: DealType): boolean {
  return category === "ゲーム" && dealType === "新品";
}
